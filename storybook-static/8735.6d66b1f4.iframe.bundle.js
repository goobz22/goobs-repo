/*! For license information please see 8735.6d66b1f4.iframe.bundle.js.LICENSE.txt */
'use strict'
        ...
        (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          function describeFiber(fiber) {
            switch (fiber.tag) {
              ...
              case 11:
                return (fiber = describeNativeComponentFrame(
                  fiber.type.render,
                  !1
                ))
              case 1:
          ...
          function pushHostContainer(fiber, nextRootInstance) {
            switch (
              ...
              case 11:
                nextRootInstance =
                  (nextRootInstance = nextRootInstance.documentElement) &&
              ...
              0 !== nonIdlePendingLanes
                ? 0 !== (pendingLanes = nonIdlePendingLanes & ~suspendedLanes)
                  ...
                  : 0 !== (pingedLanes &= nonIdlePendingLanes)
                    ...
                    : root ||
                      (0 !== (warmLanes = nonIdlePendingLanes & ~warmLanes) &&
                ...
                : 0 !== (nonIdlePendingLanes = pendingLanes & ~suspendedLanes)
                  ...
                  : 0 !== pingedLanes
                    ? (nextLanes = getHighestPriorityLanes(pingedLanes))
                    : root ||
                      (0 !== (warmLanes = pendingLanes & ~warmLanes) &&
                        (nextLanes = getHighestPriorityLanes(warmLanes))),
              0 === nextLanes
                ? 0
                : 0 !== wipLanes &&
                    ...
                    ((suspendedLanes = nextLanes & -nextLanes) >=
                      ...
                      (32 === suspendedLanes && 4194176 & warmLanes))
                  ? wipLanes
                  : nextLanes
            )
          }
          ...
          function getActiveElement(doc) {
            if (
              void 0 ===
              (doc =
                doc || ('undefined' != typeof document ? document : void 0))
            )
              return null
            try {
          ...
          function createAndAccumulateChangeEvent(
            ...
            restoreTarget
              ...
              0 <
                (inst = accumulateTwoPhaseListeners(inst, 'onChange')).length &&
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  void 0 === (curFocusedElem = priorSelectionRange.end) &&
                  ...
                  length &&
                    ...
                    ((priorSelectionInformation =
                      priorSelectionInformation.createRange()).setStart(
                      length.node,
                      length.offset
                    ),
              ...
              for (
                priorSelectionInformation = [], curFocusedElem = containerInfo;
              ...
              for (
                'function' == typeof containerInfo.focus &&
                  containerInfo.focus(),
                  containerInfo = 0;
                ...
                ((curFocusedElem =
                  priorSelectionInformation[containerInfo]).element.scrollLeft =
                  curFocusedElem.left),
          ...
          function markUpdateLaneFromFiberToRoot(sourceFiber, update, lane) {
            ...
            isHidden &&
              ...
              null === (sourceFiber = (parent = parent.hiddenUpdates)[isHidden])
          ...
          function popHydrationState(fiber) {
            ...
            var JSCompiler_temp,
              shouldClear = !1
            if (
              ((JSCompiler_temp = 3 !== fiber.tag && 27 !== fiber.tag) &&
          ...
          function pushHiddenContext(fiber, context) {
            push(
              prevEntangledRenderLanesCursor,
              ...
              do {
                ...
                if (
                  updateLane !== update.lane
                    ? (workInProgressRootRenderLanes & updateLane) ===
                      updateLane
          ...
          function pushStoreConsistencyCheck(
            ...
            ;(fiber.flags |= 16384),
              ...
              null === (getSnapshot = currentlyRenderingFiber$1.updateQueue)
                ? ((getSnapshot = {
                    lastEffect: null,
                    events: null,
                    stores: null,
          ...
          function pushSimpleEffect(tag, inst, create, deps) {
            return (
              ...
              null === (inst = currentlyRenderingFiber$1.updateQueue) &&
                ((inst = {
                  lastEffect: null,
                  events: null,
                  stores: null,
          ...
          var HooksDispatcherOnMount = {
            ...
            useSyncExternalStore: function (
              ...
              if (isHydrating) {
                ...
                if (
                  ...
                  throw Error(formatProdErrorMessage(349))
                60 & workInProgressRootRenderLanes ||
            ...
            useCacheRefresh: function () {
              return (mountWorkInProgressHook().memoizedState =
                refreshCache.bind(null, currentlyRenderingFiber$1))
            },
          }
          ...
          ;(HooksDispatcherOnUpdate.useCacheRefresh = updateRefresh),
            ...
            (HooksDispatcherOnUpdate.useOptimistic = function (
              passthrough,
              reducer
            ) {
          ...
          ;(HooksDispatcherOnRerender.useCacheRefresh = updateRefresh),
            ...
            (HooksDispatcherOnRerender.useOptimistic = function (
              passthrough,
              reducer
            ) {
              var hook = updateWorkInProgressHook()
          ...
          function createChildReconciler(shouldTrackSideEffects) {
            ...
            function updateFragment(
              ...
              return null === current || 7 !== current.tag
                ? (((current = createFiberFromFragment(
                  ...
                  current)
                : (((current = useFiber(current, fragment)).return =
                    returnFiber),
                  current)
            }
            ...
            return function (returnFiber, currentFirstChild, newChild, lanes) {
              try {
                ...
                return (
                  (fiber.lanes = lanes), (fiber.return = returnFiber), fiber
                )
              }
            }
          }
          ...
          function resolveClassComponentProps(Component, baseProps) {
            ...
            if ((Component = Component.defaultProps))
              for (var propName$67 in (newProps === baseProps &&
              ...
              if (didSuspend)
                ...
                if (
                  (JSCompiler_temp =
                    ...
                    nextInstance.nextSibling.dataset)
                )
                ...
                if (null !== (JSCompiler_temp = workInProgressRoot)) {
                  if (42 & (nextProps = renderLanes & -renderLanes))
                    nextProps = 1
                  else
                    switch (nextProps) {
                      case 2:
            ...
            return showFallback
              ? (reuseSuspenseHandlerOnStack(),
                ...
                ((nextProps = createWorkInProgress(JSCompiler_temp$jscomp$0, {
                  ...
                  31457280 & JSCompiler_temp$jscomp$0.subtreeFlags),
                null !== digest
            ...
            switch (((workInProgress.lanes = 0), workInProgress.tag)) {
              case 16:
                a: {
                  ...
                  if (
                    ...
                    throw (
                      ((workInProgress =
                        getComponentNameFromType(lazyComponent) ||
                        lazyComponent),
              ...
              case 3:
                a: {
                  ...
                  var nextProps = workInProgress.pendingProps
                  ;(lazyComponent = (init = workInProgress.memoizedState)
                    .element),
                    cloneUpdateQueue(current, workInProgress),
                    processUpdateQueue(
                      workInProgress,
          ...
          function entangleTransitions(root, fiber, lane) {
            if (
              ...
              ((fiber = fiber.shared), 4194176 & lane)
            ) {
                    ...
                    switch (update.tag) {
                      ...
                      case 0:
                        if (
                          ...
                          (updateLane =
                            'function' ==
                            typeof (workInProgress = update.payload)
                              ? workInProgress.call(
                                  instance,
                                  newState,
                                  updateLane
          ...
          function commitHookEffectListMount(flags, finishedWork) {
            try {
              var updateQueue = finishedWork.updateQueue,
                lastEffect =
                  null !== updateQueue ? updateQueue.lastEffect : null
              if (null !== lastEffect) {
            ...
            try {
              ...
              !(function updateProperties(
                ...
                switch (tag) {
                  ...
                  case 'textarea':
                    for (defaultValue in ((propKey = propKey$202 = null),
                    lastProps))
                      if (
                    ...
                    return void updateTextarea(domElement, propKey$202, propKey)
                  case 'option':
                    for (var propKey$218 in lastProps)
                      if (
                        ...
                        if ('selected' === propKey$218) domElement.selected = !1
                        else
                          setProp(
                            domElement,
                            tag,
            ...
            if (5 === tag || 6 === tag)
              (node = node.stateNode),
                before
                  ...
                  : (8 === parent.nodeType
                      ? (before = parent.parentNode).insertBefore(node, parent)
                      : (before = parent).appendChild(node),
                    null != (parent = parent._reactRootContainer) ||
                      null !== before.onclick ||
                      (before.onclick = noop$1))
            else if (4 !== tag && 27 !== tag && null !== (node = node.child))
              for (
            ...
            switch (finishedWork.tag) {
              ...
              case 1:
                if (
                  ...
                  if (
                    ((finishedRoot = finishedWork.stateNode), null === current)
                  )
                    try {
            ...
            switch (deletedFiber.tag) {
              ...
              case 27:
                ...
                for (
                  hostParent = deletedFiber.stateNode,
                    ...
                    nearestMountedAncestor = (deletedFiber =
                      deletedFiber.stateNode).attributes;
              ...
              case 6:
                ...
                if (
                  ...
                  null !== (hostParent = prevHostParentIsContainer))
                )
                      ...
                      if (null === finishedWork.stateNode) {
                        a: {
                          ...
                          b: switch (flags) {
                            case 'title':
                              ;(!(currentResource =
                                hoistableRoot.getElementsByTagName(
                                  'title'
                                )[0]) ||
                    ...
                    currentResource !== flags
                      ? (null === currentResource
                          ? null !== current.stateNode &&
                            (current =
                              current.stateNode).parentNode.removeChild(current)
              ...
              case 27:
                if (4 & flags && null === finishedWork.alternate) {
                  ...
                  try {
                    ...
                    for (
                      var type = finishedWork.type,
                        attributes = hoistableRoot.attributes;
                      attributes.length;
              ...
              case 22:
                if (
                  ...
                  (nextNode =
                    null !== current && null !== current.memoizedState),
                  (offscreenSubtreeIsHidden =
                    (nodeName = offscreenSubtreeIsHidden) || node),
                  (offscreenSubtreeWasHidden =
                    (type = offscreenSubtreeWasHidden) || nextNode),
                  recursivelyTraverseMutationEffects(root, finishedWork),
                      ...
                      if (null === current) {
                        ...
                        try {
                          if (((hoistableRoot = nextNode.stateNode), node))
                            'function' ==
                            typeof (currentResource = hoistableRoot.style)
                              .setProperty
                            ...
                            var display =
                              null != (i = nextNode.memoizedProps.style) &&
            ...
            for (
              ...
              switch (finishedWork.tag) {
                ...
                case 1:
                  ...
                  if (
                    null !==
                    (finishedRoot = (current = finishedWork).updateQueue)
                  ) {
                    var instance = current.stateNode
                    try {
          ...
          function createWorkInProgress(current, pendingProps) {
            ...
            return (
              ...
              (workInProgress.flags = 31457280 & current.flags),
          ...
          function createFiberFromTypeAndProps(
            ...
            if (((owner = type), 'function' == typeof type))
              ...
              fiberTag = (function isHostHoistableType(
                type,
                props,
                hostContext
              ) {
          ...
          function preloadResourceAndSuspendIfNeeded(workInProgress, resource) {
            if ('stylesheet' !== resource.type || 4 & resource.state.loading)
              ...
              if (
                ...
                ((4194176 & workInProgressRootRenderLanes) ===
            ...
            if (didBailout)
              for (var child$132 = completedWork.child; null !== child$132; )
                (newChildLanes |= child$132.lanes | child$132.childLanes),
                  (subtreeFlags |= 31457280 & child$132.subtreeFlags),
                  (subtreeFlags |= 31457280 & child$132.flags),
            ...
            switch ((popTreeContext(workInProgress), workInProgress.tag)) {
              ...
              case 19:
                ...
                if (
                  ...
                  if (newProps) cutOffTailIfNeeded(type, !1)
                    ...
                    if (
                      ...
                      for (current = workInProgress.child; null !== current; ) {
                        if (
                          null !== (cache$144 = findFirstSuspended(current))
                        ) {
                          for (
                            workInProgress.flags |= 128,
                  ...
                  if (!newProps)
                    if (null !== (current = findFirstSuspended(cache$144))) {
                      if (
                        ((workInProgress.flags |= 128),
                        (newProps = !0),
                        (current = current.updateQueue),
              ...
              case 24:
                return (
                  (renderLanes = null),
                  null !== current &&
                    (renderLanes = current.memoizedState.cache),
              ...
              var shouldTimeSlice =
                ...
                exitStatus = shouldTimeSlice
                  ? (function renderRootConcurrent(root, lanes) {
                      ...
                      return (
                        (lastContextDependency = currentlyRenderingFiber =
                          null),
                ...
                a: {
                  ...
                  if (
                    ...
                    (62914560 & lanes) === lanes &&
                      10 <
                        (exitStatus =
                          globalMostRecentFallbackTime + 300 - now()))
                  ) {
                    if (
                      (markRootSuspended(
                        shouldTimeSlice,
                      ...
                      0 !== getNextLanes(shouldTimeSlice, 0))
                    )
                      break a
          ...
          function commitRootWhenReady(
            ...
            if (
              (8192 & subtreeFlags || !(16785408 & ~subtreeFlags)) &&
              ((suspendedState = {
                stylesheets: null,
                count: 0,
                unsuspend: noop,
              ...
              null !==
                (finishedWork = (function waitForCommitToBeReady() {
                  if (null === suspendedState)
                    throw Error(formatProdErrorMessage(475))
                  var state = suspendedState
                  return (
          ...
          function isRenderConsistentWithExternalStores(finishedWork) {
            for (var node = finishedWork; ; ) {
              ...
              if (
                ((tag = node.child), 16384 & node.subtreeFlags && null !== tag)
              )
                              ...
                              : (null ===
                                (returnFiber = sourceFiber.updateQueue)
                                  ...
                                  : null ===
                                    ...
                                    ? (returnFiber.retryQueue = new Set([
                                        value,
                                      ]))
                ...
                (function commitRootImpl(
                  ...
                  if (
                    ((function markRootFinished(
                      ...
                      for (
                        remainingLanes =
                          previouslyPendingLanes & ~remainingLanes;
                        0 < remainingLanes;
                    ...
                    (transitions = !!(15990 & finishedWork.flags)),
                    15990 & finishedWork.subtreeFlags || transitions
                        ...
                        (function commitBeforeMutationEffects(
                          ...
                          for (
                            ...
                            if (
                              ...
                              1028 & firstChild.subtreeFlags && null !== root)
                            )
                              (root.return = firstChild), (nextEffect = root)
                            else
                              for (; null !== nextEffect; ) {
                                switch (
                                  ((focusNode = (firstChild = nextEffect)
                                    .alternate),
                                  ...
                                  case 1:
                                    if (1024 & root && null !== focusNode) {
                                      ...
                                      try {
                                        ...
                                        ;(root =
                                          selection.getSnapshotBeforeUpdate(
                                            resolvedPrevProps,
                                            focusNode
                                          )),
                                    ...
                                    if (1024 & root)
                                      if (
                                        ...
                                        (JSCompiler_temp = (root =
                                          firstChild.stateNode.containerInfo)
                                          .nodeType)
                                      )
                  ...
                  return (
                    !!(3 & pendingPassiveEffectsLanes) && flushPassiveEffects(),
                    (remainingLanes = root.pendingLanes),
                    4194218 & didIncludeRenderPhaseUpdate && 42 & remainingLanes
          ...
          function flushSyncWorkAcrossRoots_impl(
            ...
            if (!isFlushingWork && mightHavePendingSyncWork) {
              ...
              do {
                for (
                  var didPerformSomeWork = !1, root$171 = firstScheduledRoot;
                  null !== root$171;
                  ...
                  if (!onlyLegacy)
                    if (0 !== syncTransitionLanes) {
                      ...
                      if (0 === pendingLanes) var JSCompiler_inline_result = 0
                        ...
                        ;(JSCompiler_inline_result =
                          (1 << (31 - clz32(42 | syncTransitionLanes) + 1)) -
                          1),
                          (JSCompiler_inline_result =
                            201326677 &
                            (JSCompiler_inline_result &=
                              pendingLanes & ~(suspendedLanes & ~pingedLanes))
                              ? (201326677 & JSCompiler_inline_result) | 1
                              : JSCompiler_inline_result
          ...
          function processRootScheduleInMicrotask() {
            ...
            for (
              ...
              var next = root.next,
                nextLanes = scheduleTaskForRootDuringMicrotask(
                  root,
                  currentTime
                )
              0 === nextLanes
                  ...
                  'select' ===
                    (SyntheticEventCtor =
                      (reactName = targetInst
                        ...
                        : window).nodeName &&
                      reactName.nodeName.toLowerCase()) ||
                ...
                if (isCustomElement(tag)) {
                  for (propValue$185 in props)
                    props.hasOwnProperty(propValue$185) &&
                      void 0 !== (hasSrc = props[propValue$185]) &&
                      setPropOnCustomElement(
                        domElement,
                        tag,
                        propValue$185,
          ...
          ReactDOMSharedInternals.d = {
            ...
            S: function preinitStyle(href, precedence, options) {
              ...
              if (ownerDocument && href) {
                var styles =
                    getResourcesFromRoot(ownerDocument).hoistableStyles,
                  key = getStyleKey(href)
                  ...
                  return (
                    ...
                    (styleProps = hoistableRoot.querySelector(
                      ...
                      ? ((resource.instance = styleProps),
                        ...
                        styleProps)
                      : ((instance = props),
                        (styleProps = preloadPropsMap.get(instance$247)) &&
                    ...
                    switch (fiber.tag) {
                      case 3:
                        if (
                          ...
                          var lanes = getHighestPriorityLanes(
                            fiber.pendingLanes
                          )
                          if (0 !== lanes) {
                            var root = fiber
          ...
          ReactDOMSharedInternals.findDOMNode = function (componentOrElement) {
            ...
            if (void 0 === fiber) {
              ...
              throw (
                ((componentOrElement =
                  Object.keys(componentOrElement).join(',')),
              ...
              (componentOrElement = (function findCurrentFiberUsingSlowPath(
                ...
                for (var a = fiber, b = alternate; ; ) {
                  ...
                  if (a.return !== b.return) (a = parentA), (b = parentB)
                    ...
                    for (
                      var didFindChild = !1, child$2 = parentA.child;
                      child$2;
            ...
            (exports.unstable_scheduleCallback = function (
              ...
              switch (
                ('object' == typeof options && null !== options
                  ? (options =
                      'number' == typeof (options = options.delay) &&
                      0 < options
                        ? currentTime + options
                        : currentTime)
                  : (options = currentTime),
