  ...
  [
    [334, 2859, 9461],
    {
      ...
      './node_modules/@mui/material/Switch/Switch.js': (
        ...
        __webpack_require__.d(__webpack_exports__, { A: () => Switch_Switch })
        var react = __webpack_require__(
            './node_modules/next/dist/compiled/react/index.js'
          ),
          clsx = __webpack_require__('./node_modules/clsx/dist/clsx.mjs'),
        ...
        function getSwitchUtilityClass(slot) {
          return (0, generateUtilityClass.Ay)('MuiSwitch', slot)
        }
        const Switch_switchClasses = (0, generateUtilityClasses.A)(
          'MuiSwitch',
          [
            'root',
            'edgeStart',
        ...
        const SwitchRoot = (0, styled.Ay)('span', {
            name: 'MuiSwitch',
            slot: 'Root',
            overridesResolver: (props, styles) => {
              const { ownerState } = props
          ...
          SwitchSwitchBase = (0, styled.Ay)(SwitchBase.A, {
            name: 'MuiSwitch',
            slot: 'SwitchBase',
            overridesResolver: (props, styles) => {
              const { ownerState } = props
            ...
            (0, memoTheme.A)(({ theme }) => ({
              ...
              color: theme.vars
                ...
                : `${'light' === theme.palette.mode ? theme.palette.common.white : theme.palette.grey[300]}`,
              ...
              [`&.${Switch_switchClasses.disabled}`]: {
                color: theme.vars
                  ...
                  : `${'light' === theme.palette.mode ? theme.palette.grey[100] : theme.palette.grey[600]}`,
              },
                      ...
                      [`&.${Switch_switchClasses.checked}`]: {
                        ...
                        [`&.${Switch_switchClasses.disabled}`]: {
                          color: theme.vars
                            ...
                            : `${'light' === theme.palette.mode ? (0, colorManipulator.a)(theme.palette[color].main, 0.62) : (0, colorManipulator.e$)(theme.palette[color].main, 0.55)}`,
                        },
                      },
                      [`&.${Switch_switchClasses.checked} + .${Switch_switchClasses.track}`]:
                        {
          ...
          SwitchTrack = (0, styled.Ay)('span', {
            ...
            (0, memoTheme.A)(({ theme }) => ({
              ...
              backgroundColor: theme.vars
                ...
                : `${'light' === theme.palette.mode ? theme.palette.common.black : theme.palette.common.white}`,
              opacity: theme.vars
                ? theme.vars.opacity.switchTrack
                : '' + ('light' === theme.palette.mode ? 0.38 : 0.3),
            }))
          ),
          SwitchThumb = (0, styled.Ay)('span', {
            name: 'MuiSwitch',
            slot: 'Thumb',
          ...
          Switch_Switch = react.forwardRef(function Switch(inProps, ref) {
            const props = (0, DefaultPropsProvider.b)({
              ...
              ownerState = { ...props, color, edge, size },
              classes = (ownerState => {
            ...
            return (0, jsx_runtime.jsxs)(SwitchRoot, {
              className: (0, clsx.A)(classes.root, className),
              sx,
              ownerState,
              children: [
                (0, jsx_runtime.jsx)(SwitchSwitchBase, {
                  type: 'checkbox',
                  icon,
                  checkedIcon: icon,
                  ref,
                  ownerState,
                  ...other,
                  classes: { ...classes, root: classes.switchBase },
                }),
                (0, jsx_runtime.jsx)(SwitchTrack, {
      ...
      './node_modules/@mui/system/esm/useThemeProps/getThemeProps.js': (
        ...
        function getThemeProps(params) {
          ...
          return theme &&
            ...
            ? (0, _mui_utils_resolveProps__WEBPACK_IMPORTED_MODULE_0__.A)(
                theme.components[name].defaultProps,
                props
              )
            : props
