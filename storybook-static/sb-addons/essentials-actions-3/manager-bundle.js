  ...
  ;(() => {
    ...
    var Fa = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        TESTING_MODULE_CONFIG_CHANGE: Fo,
        TESTING_MODULE_CRASH_REPORT: Ho,
        TESTING_MODULE_PROGRESS_REPORT: zo,
        TESTING_MODULE_RUN_ALL_REQUEST: Uo,
        TESTING_MODULE_RUN_REQUEST: jo,
        TESTING_MODULE_WATCH_MODE_REQUEST: ko,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: Go,
        UNHANDLED_ERRORS_WHILE_PLAYING: Wo,
        UPDATE_GLOBALS: Vo,
        UPDATE_QUERY_PARAMS: $o,
        UPDATE_STORY_ARGS: Yo,
      } = __STORYBOOK_CORE_EVENTS__
    var ni = __STORYBOOK_API__,
      {
        ActiveTabs: ai,
        Consumer: oi,
        ManagerContext: ii,
        Provider: si,
        RequestResponseError: li,
        addons: Q,
        combineParameters: ui,
        controlOrMetaKey: ci,
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Ke = ({
        ...
        return o.createElement(
          ...
          t &&
            o.createElement(yr, null, o.createElement(Or, { sortAscending: e }))
        )
      },
      Tr = ({
    ...
    Q.register(z, e => {
      Q.add(Yt, {
        title: jr,
        type: De.PANEL,
        render: ({ active: t }) => o.createElement(Ur, { api: e, active: !!t }),
        paramKey: $t,
      })
    })
  })()
