  ...
  ;(() => {
      ...
      ht = ce(() => {
        ...
        ;(y = __REACT__),
          ({
            ...
            StrictMode: js,
            Suspense: rn,
            __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ds,
            cloneElement: Fs,
            createContext: Bs,
            createElement: q,
            createFactory: Ws,
      ...
      dn = ce(() => {
        ...
        ;(bl = __STORYBOOK_CORE_EVENTS__),
          ({
            ...
            TESTING_MODULE_CONFIG_CHANGE: yc,
            TESTING_MODULE_CRASH_REPORT: gc,
            TESTING_MODULE_PROGRESS_REPORT: bc,
            TESTING_MODULE_RUN_ALL_REQUEST: vc,
            TESTING_MODULE_RUN_REQUEST: Ec,
            TESTING_MODULE_WATCH_MODE_REQUEST: Sc,
            TOGGLE_WHATS_NEW_NOTIFICATIONS: Oc,
            UNHANDLED_ERRORS_WHILE_PLAYING: wc,
            UPDATE_GLOBALS: Tc,
            UPDATE_QUERY_PARAMS: Ic,
            UPDATE_STORY_ARGS: Rc,
      ...
      yn = ce(() => {
        ...
        ;(bu = __STORYBOOK_COMPONENTS__),
          ({
            ...
            codeCommon: wp,
            components: Tp,
            createCopyToClipboardFunction: Ip,
            getStoryHref: Rp,
            icons: Cp,
    ...
    var od,
      ...
      On = ce(() => {
        ...
        Q()
        Z()
        ;(od = __STORYBOOK_ICONS__),
          ({
            AccessibilityAltIcon: id,
            AccessibilityIcon: ad,
            AddIcon: sd,
            AdminIcon: ld,
            AlertAltIcon: cd,
            AlertIcon: ud,
            ...
            AlignRightIcon: dd,
            AppleIcon: fd,
            ArrowBottomLeftIcon: hd,
            ArrowBottomRightIcon: md,
            ArrowDownIcon: yd,
            ArrowLeftIcon: gd,
            ArrowRightIcon: En,
            ArrowSolidDownIcon: bd,
            ArrowSolidLeftIcon: vd,
            ArrowSolidRightIcon: Ed,
            ArrowSolidUpIcon: Sd,
            ArrowTopLeftIcon: Od,
            ArrowTopRightIcon: wd,
            ArrowUpIcon: Td,
            AzureDevOpsIcon: Id,
            BackIcon: Rd,
            BasketIcon: Cd,
            ...
            ChevronLeftIcon: Qd,
            ChevronRightIcon: Zd,
            ChevronSmallDownIcon: ef,
            ChevronSmallLeftIcon: tf,
            ChevronSmallRightIcon: nf,
            ChevronSmallUpIcon: rf,
            ChevronUpIcon: of,
            ChromaticIcon: af,
            ChromeIcon: sf,
            CircleHollowIcon: lf,
            ...
            PinAltIcon: Qh,
            PinIcon: Zh,
            PlayAllHollowIcon: em,
            PlayBackIcon: tm,
            PlayHollowIcon: nm,
            PlayIcon: rm,
            PlayNextIcon: om,
            PlusIcon: im,
            PointerDefaultIcon: am,
            PointerHandIcon: sm,
            PowerIcon: lm,
            PrintIcon: cm,
            ProceedIcon: um,
            ...
            SideBySideIcon: Pm,
            SidebarAltIcon: _m,
            SidebarAltToggleIcon: xm,
            SidebarIcon: Am,
            SidebarToggleIcon: Nm,
            SpeakerIcon: km,
            StackedIcon: Lm,
            StarHollowIcon: Mm,
            StarIcon: jm,
            ...
            if (g === i) {
              ...
              for (let [Ke, { color: Te }] of Fn(d)) {
                ...
                JSON.stringify(n) !== JSON.stringify(V) &&
                  ...
                  O !== a &&
                    Ie.style.setProperty('--br', b(O, h()) ? '50%' : '0'),
                  P !== c &&
                    (c && Ie.classList.remove(c), P && Ie.classList.add(P))
              }
            } else Be = !0
            l && !ke && clearTimeout(v),
    ...
    function $n(e) {
      return t =>
        C.array(e)
          ? e.some(n => oe(n, t) || (C.array(t) && Vt(t)(n)))
          : oe(e, t)
    }
    function Qe(e, t) {
    ...
    function xr(e) {
      ...
      for (var t = e.parentElement; t && Fe(t, 'transform') === 'none'; )
        t = t.parentElement
    ...
    function Fr(e, t, n, r) {
      ...
      i.addEventListener(t, n, { passive: !0 }),
        o || Fr(at(i.parentNode), t, n, r),
        r.push(i)
    }
    function fi(e, t, n, r) {
      ;(n.updateBound = r),
        Dr(e).addEventListener('resize', n.updateBound, { passive: !0 })
      var o = at(e)
      return (
    ...
    function bi(e) {
      return (
        ...
        e.arrowElement &&
          ...
          Gt(e.arrowElement, e.arrowStyles),
        e
      )
    }
    ...
    function wi(e, t) {
      ...
      return (
        ...
        (e.arrowElement = r),
        (e.offsets.arrow =
          ((n = {}), ze(n, u, Math.round(m)), ze(n, d, ''), n)),
        e
      )
    }
    function Ti(e) {
    ...
    function _t(e, t, n) {
      ...
      if (r) {
        ...
        if (!(r.scrollHeight > r.offsetHeight) && !t)
          return (r.style.overflow = 'initial'), je()
      }
      return r
    }
    function dt(e, t) {
    ...
    function Va(e) {
      ...
      return (
        r &&
          ((H.primary = i ? B : P),
          N &&
            (H.primary = q('span', null, H.primary, ' (', o + 1, '/', s, ')'))),
        H.primary &&
          (H.primary = q(
            'button',
            {
        ...
        ;(po = Object.create),
          ...
          ($t = le({
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function l(m, g) {
                return g.clone !== !1 && g.isMergeableObject(m)
                  ? v(c(m), m, g)
                  : m
              }
              function p(m, g, O) {
              ...
              function b(m, g) {
                return (
                  h(m, g) &&
                  !(
                    Object.hasOwnProperty.call(m, g) &&
            ...
            '../../node_modules/prop-types/factoryWithTypeCheckers.js'(e, t) {
              ...
              t.exports = function (l, p) {
                ...
                function H(E) {
                  ...
                  function x(W, D, L, G, M) {
                    for (var F = W[D], z = 0; z < E.length; z++)
                      if (N(F, E[z])) return null
                ...
                function Ke(E) {
                  function x(W, D, L, G, M) {
                    ...
                    for (var Y in K) {
                      var w = E[Y]
                      if (i(E, Y) && typeof w != 'function')
                        return ke(L, G, M, Y, Re(w))
                      if (!w)
                        return new v(
                          'Invalid ' +
                            G +
...
Valid keys: ` +
        ...
        R.asyncGeneratorFunction = function (e) {
          return Pt(e) === 'AsyncGeneratorFunction'
        }
        ...
        ;(Ui = Ur('function')),
          ...
          (tr = function (e) {
            return !Gi(e) && !Hi(e) && (Ui(e) || typeof e == 'object')
          }),
          (Gi = Ur('undefined')),
          (Yt = function (e) {
            ...
            ct(n, [
              {
                ...
                value: function () {
                  ve() &&
                    (this.node || this.appendNode(), et || this.renderPortal())
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var r = this.props,
                    o = r.children,
                    i = r.setRef
                  if ((this.node || this.appendNode(), et))
                    return Me.createPortal(o, this.node)
                ...
                },
                {
                  ...
                  value: function (r, o) {
                    if (ve()) {
                      ...
                      if (r.open !== s) {
                        var f
                        A.boolean(s) && (f = s ? U.OPENING : U.CLOSING),
                          this.toggle(f)
                      }
                    ...
                    if (i) {
                      ...
                      new Zn(this.target, this.wrapperRef, {
                        ...
                        onCreate: function (g) {
                          ;(r.wrapperPopper = g),
                            r._isMounted &&
                              r.setState({ statusWrapper: U.IDLE }),
                            c(g, 'wrapper'),
                            u !== g.placement &&
                              setTimeout(function () {
                                g.instance.update()
        ...
        ;(Ka = Va),
          ...
          (Xa = class extends Le {
            ...
            componentDidUpdate(e) {
              ...
              h('lifecycle', k.INIT, k.READY) &&
                ...
                f('lifecycle', k.BEACON) &&
                  r({ ...b, step: u, type: pe.BEACON }),
                f('lifecycle', k.TOOLTIP) &&
                  (r({ ...b, step: u, type: pe.TOOLTIP }),
                  this.tooltip &&
                    ((this.scope = new za(this.tooltip, {
          ...
          (ro = class extends Le {
            ...
            componentDidUpdate(e, t) {
              ...
              if (
                (B &&
                  (hr(p, s) ? h(p) : console.warn('Steps are not valid', p)),
                T('run') && (c ? b(l) : N()),
                P)
              ) {
                ...
                ;(b = b >= 0 ? b : 0),
                  r === j.RUNNING &&
                    Ra(b, { element: h, duration: a }).then(() => {
                      setTimeout(() => {
                        var T
                        ;(T = this.store.getPopper('tooltip')) == null ||
                          T.instance.update()
                      }, 10)
                    })
              }
