      ...
      './node_modules/@mui/material/Popper/Popper.js': (
        ...
        function getClippingRect(element, boundary, rootBoundary, strategy) {
          var mainClippingParents =
            ...
            clippingRect = clippingParents.reduce(
                    ...
                    for (
                      var _options$mainAxis = options.mainAxis,
                        ...
                        placements = [preferredPlacement]
                          ...
                          .reduce(function (acc, placement) {
                            return acc.concat(
                              'auto' === getBasePlacement(placement)
                    ...
                    if (makeFallbackChecks)
                      for (
                        var _loop = function _loop(_i) {
                            var fittingPlacement = placements.find(
                              function (placement) {
        ...
        function getPopperUtilityClass(slot) {
          return (0, generateUtilityClass.Ay)('MuiPopper', slot)
        }
        ;(0, generateUtilityClasses.A)('MuiPopper', ['root'])
        ...
        const defaultPopperOptions = {},
          PopperTooltip = react.forwardRef(
            function PopperTooltip(props, forwardedRef) {
              const {
                  anchorEl,
                  children,
                  direction,
                ...
                ownRef = (0, useForkRef.A)(tooltipRef, forwardedRef),
                popperRef = react.useRef(null),
                handlePopperRef = (0, useForkRef.A)(popperRef, popperRefProp),
              ...
              const rtlPlacement = (function flipPlacement(
                  placement,
                  direction
                ) {
          ...
          BasePopper = react.forwardRef(function Popper(props, forwardedRef) {
            const {
                anchorEl,
                children,
            ...
            if (containerProp) container = containerProp
              ...
              container =
                resolvedAnchorEl && BasePopper_isHTMLElement(resolvedAnchorEl)
                  ? (0, ownerDocument.A)(resolvedAnchorEl).body
                  : (0, ownerDocument.A)(null).body
            }
            const display =
            ...
            return (0, jsx_runtime.jsx)(Portal.A, {
              disablePortal,
              container,
              children: (0, jsx_runtime.jsx)(PopperTooltip, {
                anchorEl,
                direction,
                disablePortal,
                modifiers,
        ...
        const PopperRoot = (0, styled.Ay)(BasePopper, {
          ...
          material_Popper_Popper = react.forwardRef(
            function Popper(inProps, ref) {
              const isRtl = (0, RtlProvider.I)(),
                ...
                RootComponent = slots?.root ?? components?.Root,
                otherProps = {
                  anchorEl,
                  container,
                  disablePortal,
              ...
              return (0, jsx_runtime.jsx)(PopperRoot, {
                as: component,
